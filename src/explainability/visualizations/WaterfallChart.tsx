 ...
 * 
 * Data flow:
 * Baseline (68) + Circularity (+14) + Fragmentation (+8) - Boundary (-3) = Final (87)
 */
const WaterfallChart: React.FC<WaterfallChartProps> = ({ embryo }) => {
  // Mock waterfall data - in production, compute from explainability data
  const baselineScore = 68;
  const factors = [
    { name: 'Baseline', value: baselineScore, fill: '#9CA3AF', type: 'baseline' },
    { name: '+Circularity', value: 14, fill: '#10B981', type: 'positive' },
    { name: '+Fragmentation', value: 8, fill: '#10B981', type: 'positive' },
    { name: '-Boundary', value: -3, fill: '#EF4444', type: 'negative' },
  ];
