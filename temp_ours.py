...
def generate_explainability(
    ...
    try:
        ...
        if circularity > 0.75:
            decision_factors.append("Γ£ô Excellent cell shape and symmetry")
        elif circularity < 0.55:
            decision_factors.append("ΓÜá Irregular cell shape detected")
        
        if std_dev < 40:
            decision_factors.append("Γ£ô Low fragmentation - uniform appearance")
        elif std_dev > 60:
            decision_factors.append("ΓÜá High pixel variation suggests fragmentation")
        
        if edge_density > 0.15:
            decision_factors.append("Γ£ô Well-defined cell boundaries")
        elif edge_density < 0.10:
            decision_factors.append("ΓÜá Poor boundary definition")
        
        if num_regions < 10:
            decision_factors.append("Γ£ô Minimal cellular fragmentation")
        elif num_regions > 20:
            decision_factors.append("ΓÜá Multiple fragments/regions detected")
