...
import DecisionPathDAG from './visualizations/DecisionPathDAG';
    ...
    <div className="w-full h-full animate-fadeIn">
      ...
      {activeTab === 'summary' && (
        <div className="space-y-6">
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-4">How Your Score Was Calculated</h2>
            <p className="text-sm text-slate-600 mb-6">
              The waterfall below shows how individual morphological factors contributed to your final viability score of{' '}
      ...
      {activeTab === 'morphometry' && (
        <div className="space-y-6">
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-4">Morphometry Analysis</h2>
            <p className="text-sm text-slate-600 mb-6">
              Detailed morphological measurements and quality metrics for this embryo
            </p>
          </div>
      ...
      {activeTab === 'attribution' && (
        <div className="space-y-6">
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-4">Feature Attribution Analysis</h2>
            <p className="text-sm text-slate-600 mb-6">
              Ranked feature importance showing which morphological characteristics most influenced the AI prediction
            </p>
          </div>
      ...
      {/* Decision Path Tab: Clinical Logic Flow */}
      {activeTab === 'decision' && (
        <div className="space-y-6">
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-4">Decision Path & Clinical Logic</h2>
            <p className="text-sm text-slate-600 mb-6">
              Visual representation of how the AI model processed this embryo's data to reach the final recommendation
            </p>
          </div>
          <DecisionPathDAG embryo={embryo} />
        </div>
      )}
